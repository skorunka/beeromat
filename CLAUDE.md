...
at `specs/003-forms-input-hardening/plan.md`. Companion artifacts in the
same directory: `spec.md`, `research.md`, `data-model.md`,
`quickstart.md`, and `contracts/forms.md`. The earlier features live at
